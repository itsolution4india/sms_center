...
urlpatterns = [
    ...
    path('phonenumbers/add/', views.whatsapp_add, name='whatsapp_add'),
    path('phonenumbers/edit/<int:number_id>/', views.whatsapp_edit, name='whatsapp_edit'),
    path('phonenumbers/delete/<int:number_id>/', views.whatsapp_delete, name='whatsapp_delete'),
    path('phonenumbers/detail/<int:number_id>/', views.whatsapp_detail, name='whatsapp_detail'),
]